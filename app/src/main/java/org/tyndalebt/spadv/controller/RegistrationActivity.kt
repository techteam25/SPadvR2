...
open class RegistrationActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        // to build type:
        // Release build:       org.tyndalebt.spadv:id/input_ethnologue
        // Continuous build:    org.tyndalebt.spadvv.ci:id/input_ethnologue
        ...
        private val ID_PREFIX = "org.tyndalebt.spadv[.a-z]*:id/input_".toRegex()
